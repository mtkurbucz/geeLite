---
title: "**geeLite** R Package <span style='font-size: 12px;'>(*Version 0.1.0*)</span>"
subtitle: "<span style='color: #A0AEBB; font-weight: normal;'>Authors:</span>"
author: |
  Marcell T. Kurbucz
  (*[email](mailto:mkurbucz@worldbank.org)*) <br>
...
```{r config-setup, eval = FALSE, warning = FALSE}
...
```{r collecting-data-example, warning = FALSE}
# Define the path for the SQLite database
path <- path_to_db
